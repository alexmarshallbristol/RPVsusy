...
files = glob.glob('/eos/experiment/ship/user/amarshal/RPV_output/NEW/grid_data_rpv_4_1_1_5000_*_0.npy')
...
acceptance = np.divide(data_total[:,5],data_total[:,14])
masses = data_total[:,0]
...
plt.savefig('acceptance2',bbox_inches='tight')
